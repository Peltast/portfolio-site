define("Prop", ['Point', 'GameObject'], function(Point, GameObject) {
    ...
    class Prop extends GameObject {
        ...
        removeParticleSystem(oldSystem) {
            this.spriteContainer.removeChild(oldSystem.systemContainer);
            this.particleEffects.splice(this.particleEffects.indexOf(oldSystem), 1);
        }
