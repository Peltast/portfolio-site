...
<tileset version="1.2" tiledversion="1.2.3" name="CoreTileset" tilewidth="32" tileheight="32" tilecount="195" columns="13">
 <image source="../images/tiles/CoreTileset.png" width="416" height="480"/>
 <terraintypes>
  ...
  <terrain name="GroundDark" tile="0">
   <properties>
    <property name="passable" value="true"/>
   </properties>
  </terrain>
  <terrain name="GroundLight" tile="0">
   <properties>
    <property name="passable" value="true"/>
   </properties>
  </terrain>
 ...
 <tile id="22" terrain="2,1,1,1"/>
 <tile id="23" terrain="1,1,1,1"/>
 <tile id="24" terrain="1,2,1,1"/>
