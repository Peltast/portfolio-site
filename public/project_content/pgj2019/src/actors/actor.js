...
function(       GameObject, Point, CollisionBox, ActorController) {
    ...
    class Actor extends GameObject {
        ...
        updateDirection() {
            ...
            if (this.goingUp && this.currentController.acceptInput) {
                this.targetVelocity.Y = -this.currentController.maxSpeed;
                // this.orientation += "up";
            }
            else if (this.goingDown && this.currentController.acceptInput) {
                this.targetVelocity.Y = this.currentController.maxSpeed;
        ...
        updateOrientation() {
            ...
            if (this.goingRight) {
                if (this.goingUp) {
                    this.spriteContainer.rotation = 315;
                    this.orientation = "rightup";
                }
                else if (this.goingDown) {
                    this.spriteContainer.rotation = 45;
                    this.orientation = "rightdown";
                }
                else {
                ...
                if (this.goingDown) {
                    this.spriteContainer.rotation = 125;
                    this.orientation = "leftdown";
                }
                else if (this.goingUp) {
                    this.spriteContainer.rotation = 225;
                    this.orientation = "leftup";
                }
                else {
                    this.spriteContainer.rotation = 180;
                    this.orientation = "left";
                }
            }
            else if (this.goingUp) {
                this.spriteContainer.rotation = 270;
                this.orientation = "up";
            }
            else if (this.goingDown) {
                this.spriteContainer.rotation = 90;
                this.orientation = "down";
            }
        }
