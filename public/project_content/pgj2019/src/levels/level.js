define("Level", [
        ...
        'Point', 'Actor', 'Enemy', 'Shard', 'Prop', 'ParallaxProp', 'Collectible', 'Transition', 'EnemySpawnPoint', 'ParticleSystem', 'PaintArea'], 
    function (
        Point, Actor, Enemy, Shard, Prop, ParallaxProp, Collectible, Transition, EnemySpawnPoint, ParticleSystem, PaintArea
    ) {
    ...
    class Level {
        ...
        createLevel() {
            ...
            this.paintLayer = new createjs.Container();
            ...
            this.levelContainer.addChild(this.paintLayer);
        ...
        resetLevel() {
            ...
            this.objects = [];
            this.paintLayer.removeAllChildren();
        ...
        initMapObjects(objectList) {
            ...
            for (let i = 0; i < objectList.length; i++) {
                ...
                else if (newObject instanceof PaintArea) {
                    this.paintLayer.addChild(newObject.paintContainer);
        ...
        spawnNewEnemy(location) {
            var newEnemy = objectFactory.createMainEnemy(location);
        ...
        initLevelData(levelData) {
            ...
            if (levelData["goal"])
                this.goalNumber = levelData["goal"];
        }
        ...
        addActor(newActor) {
            ...
            if (newActor == player) {
                this.spriteLayer.addChild(newActor.playerContainer);
            }
            else if (!this.spriteLayer.contains(newActor.spriteContainer))
        ...
        removeActor(oldActor) {
            if (oldActor != null) {
                ...
                if (oldActor == player)
                    this.spriteLayer.removeChild(oldActor.playerContainer);
                else
